...
```groovy
implementation 'io.github.aaabramov:glogging-core:0.3.0'
implementation 'io.github.aaabramov:glogging-gson:0.3.0'
// OR 
// implementation 'io.github.aaabramov:glogging-jackson:0.3.0'
```
